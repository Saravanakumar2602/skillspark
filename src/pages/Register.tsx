      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-white border-r border-gray-200 p-12">
        <div className="relative z-20">
          <div className="flex items-center gap-2 text-lg font-semibold">
            ...
            <span className="text-black">SkillSpark</span>
          </div>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight mb-2 text-black">Create Account</h1>
            <p className="text-gray-600 text-sm">Join our student talent community</p>
          </div>
