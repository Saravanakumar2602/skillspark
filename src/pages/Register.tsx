...
export function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const existingUsers = JSON.parse(localStorage.getItem("skillspark_users") || "[]");
    ...
    localStorage.setItem("skillspark_users", JSON.stringify(existingUsers));
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 text-xs font-medium">
              Join our student talent community today
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5 mt-2">
            ...
            {error && (
              <div className="p-3.5 text-xs text-red-650 bg-red-50 border border-red-200/60 rounded-xl flex items-center gap-2">
          ...
          <div className="text-center text-xs text-slate-500 mt-6 pt-2 border-t border-slate-100">
            ...
            <Link to="/login" className="text-[#6C63FF] font-extrabold hover:underline">
              Log In
            </Link>
          </div>
        </motion.div>
